...
public class NavActivitySakhi extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nav_sakhi);
        ...
        navigationView.setCheckedItem(R.id.nav_orderlist);

        //NOTE:  Open fragment1 initially.
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ft.replace(R.id.mainFrame, new OrderList());
        ft.commit();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.nav_activity_sakhi, menu);
        return true;
    }
